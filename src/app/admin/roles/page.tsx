...
export default function RolesPage() {
  ...
  const handleCreateRole = async (values: { role_id: string; name: string; description: string; scope: 'global' | 'app'; app_id?: string; permission_ids: string[] }) => {
    try {
  ...
  const handleUpdateRole = async (values: { name: string; description: string; permission_ids: string[] }) => {
  ...
  const columns = [
    {
      title: 'Role',
      key: 'role',
      render: (_, record: RoleWithDetails) => (
        ...
        <Space direction="vertical" size="small">
          ...
          <div>
            ...
            {record.permissionNames.length > 3 && (
              <Tag size="small">+{record.permissionNames.length - 3} more</Tag>
            )}
          </div>
        </Space>
      ),
                  ...
                  <div>
                    <Descriptions bordered column={1}>
                      ...
                      <Descriptions.Item label="Scope">
                        <Tag 
                          icon={selectedRole.scope === 'global' ? <GlobalOutlined /> : <AppstoreOutlined />}
                      ...
                      <Descriptions.Item label="Created By">{selectedRole.created_by}</Descriptions.Item>
                    </Descriptions>
